...
Route::get('/pesanan/getLastAdd', [pesananController::class, 'getLastAdd']);
...
Route::get('search-menu/{string}', [menuController::class, 'searchMenu']);
Route::apiResource('/kategori', kategoriController::class);
Route::apiResource('/keranjang', keranjangController::class);
Route::put('/keranjang/updateJumlah/{id}', [keranjangController::class, 'updateJumlah']);
...
Route::put('/user/update-status/{id}', [userController::class, 'updateStatus']);
